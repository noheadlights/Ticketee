Feature: Editing Projects
  ...
  Background:
    ...
    And there is a project called "TM2"
  ...
  Scenario: Updating a project without a duplicate name
    And I fill in "Name" with "TM2"
    And I press "Update Project"
    Then I should see "Project has not been updated."
    And I should see "Name has already been taken"

  Scenario: Updating a project with no project name
